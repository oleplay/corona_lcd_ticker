...
void getData()
{
    ...
    // String data = "Das neue Coronavirus Sars-CoV-2 wird vor allem durch direkten Kontakt zwischen Menschen - beispielsweise im Gespräch - durch kleine Tröpfchen übertragen.";
